        ...
        <AuthenticatedLayout auth={auth}>
            ...
            <div className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
                <form onSubmit={submit}>
                    ...
                    <InputError message={errors.title} className="mt-2" />
                    <PrimaryButton
                        className="mt-4 text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg"
                        disabled={processing}
                    >
                        Create
                    </PrimaryButton>
